    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="advertImageCropButton" type="button" class="btn btn-success" >@lang('core.crop')</button>
                <button type="button" class="btn default" data-dismiss="modal">@lang('core.close')</button>
            </div>
        </div>
    </div>
</div>