                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> @lang('menu.themeSettings') </span>
                                </div>
                                <div class="actions">
                                </div>
                            </div>
                            <div class="portlet-body form">
                                ...
                                <div class="form-body md-radio-list">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 text-center">
                                                 ...
                                                 <img id="elite-admin-img" src="{{asset('theme-images/elite-admin'.(($global->theme_folder=='elite-admin')?'-'.$global->theme_color:'').'.jpg')}}" style="width: 85%;height: 100%;margin-top: 10px;">
                                        </div>
