...
<head>
    ...
    <link href="{{ asset($global->theme_folder.'/global/plugins/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset($global->theme_folder.'/global/css/components-md.min.css') }}" rel="stylesheet" id="style_components" type="text/css" />
    <link href="{{ asset($global->theme_folder.'/global/css/plugins-md.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="{{ asset($global->theme_folder.'/pages/css/login.css') }}" rel="stylesheet" type="text/css" />
