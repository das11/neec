...
<div class="modal-body">
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" @if(isset($permissions) && in_array($permissions->name,$permdata)) readonly @endif name="name" id="name" class="form-control"  value="{{ $permissions->name or old('name') }}" placeholder="@lang('core.enterPermissionName')">
            </div>
        </div>
...
<div class="modal-footer">
    <button id="save" type="submit" class="btn btn-custom" onclick="knap.addUpdate('permissions', '{{$permissions->id or ''}}');return false">@lang('core.submit')</button>
