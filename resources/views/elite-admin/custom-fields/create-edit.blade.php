...
<div class="panel-heading">
    ...
    <span class="modal-title">@if(isset($permissions->id)) @lang('menu.editField')@else @lang('menu.addField') @endif </span>
</div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="radio radio-success">
                            ...
                            <label for="optionsRadios1"> @lang('core.yes') </label>
                    ...
                    <div class="radio radio-success">
                            ...
                            <label for="optionsRadios2"> @lang('core.no') </label>
...
<div class="modal-footer">
    ...
    <button id="save" type="submit" class="btn btn-custom" onclick="knap.addUpdate('custom-fields', '');return false">@lang('core.submit')</button>
</div>
{{ Form::close() }}
<script>
