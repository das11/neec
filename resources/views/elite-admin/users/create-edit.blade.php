<div class="panel-heading">
    ...
    <span class="modal-title">@if(isset($editUser->id)) @lang('core.edit')@else @lang('core.add') @endif @lang('core.user') </span>
</div>
    ...
    <div class="box-body">
        ...
        @if(isset($editUser->id))
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="radio radio-success">
                        <input type="radio" name="status" id="optionsRadios1" value="active"
                               @if($editUser->status=='active') checked @endif>
                        <label for="optionsRadios1">   @lang('core.active') </label>
                    ...
                    <div class="radio radio-success">
                        ...
                        <input type="radio" name="status" id="optionsRadios2" value="inactive"
                               @if($editUser->status=='inactive') checked @endif>
                        <label for="optionsRadios2">   @lang('core.inactive') </label>
...
<div class="modal-footer">
    <button id="save" type="submit" class="btn btn-custom" onclick="knap.addUpdate('users', '{{$editUser->id or ''}}');return false">@lang('core.submit')</button>
